<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionExpired.aspx.cs" Title="<%$ Resources:SessionExpired %>" Inherits="BugNET.Errors.SessionExpired" UICulture="auto" %>
