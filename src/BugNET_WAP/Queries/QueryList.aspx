<%@ Page Language="c#" CodeBehind="QueryList.aspx.cs" AutoEventWireup="True" MasterPageFile="~/Shared/SingleColumn.master" Title="Query List" Inherits="BugNET.Queries.QueryList" UICulture="auto"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
	...
	<div style="margin-top:10px;margin-bottom:10px;">
        ...
        <asp:Button Text="Edit Query"  meta:resourcekey="EditQueryButton" Class="standardText" Runat="server" id="EditQueryButton" onclick="EditQuery" />
    </div>
