<%@ Page language="c#" Inherits="BugNET.Administration.Projects.ProjectList"  MasterPageFile="~/Shared/SingleColumn.master" meta:resourcekey="Page" Title="Project List" Codebehind="ProjectList.aspx.cs" UICulture="auto" %>
<asp:Content ContentPlaceHolderID="content" runat="server" ID="Content1">
    ...
    <div style="padding:0px 0 10px 0;">
        <span style="padding-right:5px;border-right:1px dotted #ccc" id="NewProject" runat="server">
            ...
            <asp:HyperLink ID="lnkNewProject" runat="server"  NavigateUrl="~/Administration/Projects/AddProject.aspx" Text="<%$ Resources:SharedResources, AddProject %>"/>
        </span>
        &nbsp;
