...
namespace BugNET.SvnBrowse
{
    public partial class SubversionShowLog : BugNET.UserInterfaceLayer.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {                
                DataColumn column;
                string svnUrl = "https://192.168.0.225/svn/openflow/program/trunk";
        ...
        {
            string command = "svn";
            string args = string.Format("--username {0} --password {1} --non-interactive --trust-server-cert log {2}", "dyx", "holystar", svnUrl);
            //string command = "cmd";
            //string args = "dir";          
