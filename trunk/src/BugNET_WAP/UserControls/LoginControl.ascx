...
<asp:Panel ID="pnlLoginControl" runat="server" OnLoad="pnlLoginControl_Load">
    <asp:Login ID="subLoginControl" runat="server" DestinationPageUrl="~/Default.aspx" PasswordRecoveryText="Forgot your password?"
        PasswordRecoveryUrl="~/Account/ForgotPassword.aspx" TitleText="Login" VisibleWhenLoggedIn="False" OnLoad="LoginControl_Load">
                ...
                <tr>
                    <td>
                        <table border="0" cellpadding="0" style="width: auto; margin-left: 25px; margin-top: 10px;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:HyperLink ID="PasswordRecoveryLink" runat="server" Font-Size="90%" meta:resourcekey="PasswordRecoveryLink" NavigateUrl="~/Account/ForgotPassword.aspx">Forgot your password?</asp:HyperLink>
                                </td>
                            </tr>
                        </table>
                    </td>
